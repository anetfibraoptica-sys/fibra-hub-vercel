...
const FibraDB = {
  ...
  async request(path, options = {}){
    ...
    const res = await fetch(FIBRA_SUPABASE_URL + "/rest/v1/" + path, { method: options.method || "GET",
      headers,
  ...
  clienteToRow(c){
    return {
      ...
      dias_atraso_bloqueio: Number(c.dias_atraso_bloqueio || c.diasAtrasoBloqueio || 0) || null,
