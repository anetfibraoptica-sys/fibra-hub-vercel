...
function servidorConfig(nomeServidor) {
  ...
  if (nome.includes("ARMANDO") || nome.includes("ZUMBI")) {
    return {
      ...
      host: pick(
        ...
        "MK_ARMANDO_HOST",
        "ARMANDO_HOST",
        "MIKROTIK_HOST_ARMANDO",
        "MIKROTIK1_HOST"
      ),
      port: pickPort(
        "MIKROTIK_ARMANDO_PORT",
        "MK_ARMANDO_PORT",
        "ARMANDO_PORT",
        "MIKROTIK_PORT_ARMANDO",
        "MIKROTIK1_PORT"
      ),
      user: pick(
        ...
        "MK_ARMANDO_USER",
        "ARMANDO_USER",
        "MIKROTIK_USER_ARMANDO",
        "MIKROTIK1_USER"
      ),
      pass: pick(
        "MIKROTIK_ARMANDO_PASS",
        "MIKROTIK_ARMANDO_PASSWORD",
        "MK_ARMANDO_PASS",
        "ARMANDO_PASS"
      )
    };
  ...
  return {
    ...
    host: pick(
      ...
      "MK_COLONIA_HOST",
      "COLONIA_HOST",
      "MIKROTIK_HOST_COLONIA",
      "MIKROTIK2_HOST"
    ),
    port: pickPort(
      "MIKROTIK_COLONIA_PORT",
      "MK_COLONIA_PORT",
      "COLONIA_PORT",
      "MIKROTIK_PORT_COLONIA",
      "MIKROTIK2_PORT"
    ),
    user: pick(
      ...
      "MK_COLONIA_USER",
      "COLONIA_USER",
      "MIKROTIK_USER_COLONIA",
      "MIKROTIK2_USER"
    ),
    pass: pick(
      "MIKROTIK_COLONIA_PASS",
      "MIKROTIK_COLONIA_PASSWORD",
      "MK_COLONIA_PASS",
      "COLONIA_PASS"
    )
  };
